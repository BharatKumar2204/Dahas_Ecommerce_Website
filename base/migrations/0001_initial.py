# Generated by Django 4.0.6 on 2022-12-29 07:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countInStock_S', models.IntegerField(blank=True, default=0, null=True)),
                ('countInStock_M', models.IntegerField(blank=True, default=0, null=True)),
                ('countInStock_L', models.IntegerField(blank=True, default=0, null=True)),
                ('countInStock_XL', models.IntegerField(blank=True, default=0, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
